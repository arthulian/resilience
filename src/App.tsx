...
const frameworks: Framework[] = [
  {
    id: 'sense-making',
    title: 'Sense-Making',
    content: 'Extract constant patterns from situations or circumstances → form symbolic representations → organize concepts into relational schemas → enable interpretation, inference, and evaluation.',
  ...
  },
  {
    ...
    content: 'Assess propositions, their likelihood, and evidential warrant → evaluate argument soundness and evidence relevance → clarify relations among claims, evidence, and inferences.',
  ...
  },
  {
    id: 'objectivity',
    title: 'Objectivity',
    content: 'Identify uneven evidentiary standards or motives → uniformly apply empirical and rational criteria to all conclusions → through ongoing self-critique.',
  ...
  },
  {
    ...
    content: 'Establish priorities and goals → voluntarily inhibit wants → Execute “shoulds” despite internal resistance → align behavior to long-term objectives.',
  ...
  },
  {
    id: 'perseverance',
    title: 'Perseverance',
    content: 'Commit to valued outcomes → override fear-based avoidance → persist in goal-directed action → Through repeated, graded exposure and deliberate skill-building.',
